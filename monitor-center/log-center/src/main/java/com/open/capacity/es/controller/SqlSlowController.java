...
//        SortBuilder sortBuilder= SortBuilders.fieldSort("timestamp").order(SortOrder.DESC).unmappedType("date");
//        SearchQuery query = new NativeSearchQueryBuilder().withQuery(builder).withPageable(pageable).withSort(sortBuilder).build();
