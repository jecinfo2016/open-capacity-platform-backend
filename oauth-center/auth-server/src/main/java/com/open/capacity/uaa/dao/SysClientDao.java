...
public interface SysClientDao {
    ...
    @Insert("insert into oauth_client_details(client_id,client_name, resource_ids, client_secret,client_secret_str, scope, "
    		...
    		+ " values(#{clientId},#{clientName}, #{resourceIds}, #{clientSecret},#{clientSecretStr}, #{scope}, "
