...
public class ValidatorUtil  {
	...
	*/
	...
	private static String REGEX_MOBILE = "^1[3|4|5|7|8][0-9]\\\\d{4,8}$";
     ...
     * 正则表达式:验证密码(不包含特殊字符)
     */
    public static final String REGEX_USERPASS = "^[a-zA-Z0-9]{6,16}$";
    ...
    public static boolean isPassword(String password) {
        return Pattern.matches(REGEX_USERPASS, password);
    }
