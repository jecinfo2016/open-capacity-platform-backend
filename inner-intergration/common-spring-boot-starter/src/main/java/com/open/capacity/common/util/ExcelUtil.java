...
import com.open.capacity.common.annotation.Excel.ColumnType;
import com.open.capacity.common.annotation.Excel.Type;
import com.open.capacity.common.annotation.Excels;
...
public class ExcelUtil<T>
{
    ...
    private static String tmpFileDir = System.getProperty("user.dir")+File.separator+"temp";
    ...
    {
        String downloadPath = tmpFileDir + filename;
