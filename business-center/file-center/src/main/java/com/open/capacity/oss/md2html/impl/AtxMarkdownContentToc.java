...
package com.open.capacity.oss.md2html.impl;


import com.open.capacity.oss.md2html.*;
...
import com.open.capacity.oss.md2html.toc.TocVo;
...
public class AtxMarkdownContentToc implements MarkdownContentToc {
    ...
    public List<String> getPureTocList(List<String> contentLines) {
        if (CatalogUtil.isEmpty(contentLines)) {
    ...
    private List<String> buildTocList(final List<String> contentList) {
        if (CatalogUtil.isEmpty(contentList)) {
            return Collections.emptyList();
        }
    ...
    private void fillTocVo(TocVo tocVo) {
        ...
        if(config.isOrder()) {
            ...
            tocVo.setOrderDesc(CatalogUtil.EMPTY);
        }
    }
    ...
    private String buildOrderDesc(final TocVo tocVo) {
        ...
        return CatalogUtil.join(orderList, TocConstant.DOT)+ CatalogUtil.BLANK;
    }
