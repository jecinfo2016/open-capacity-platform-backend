...
import org.opentsdb.response.SimpleHttpResponse;
...
public class PoolingHttpClient {
	...
	private static final int DEFAULT_CONNECTION_TIMEOUT_MILLISECONDS = (100 * 1000);
	private static final int DEFAULT_READ_TIMEOUT_MILLISECONDS = (100 * 1000);
	private static final int DEFAULT_WAIT_TIMEOUT_MILLISECONDS = (100 * 1000);
