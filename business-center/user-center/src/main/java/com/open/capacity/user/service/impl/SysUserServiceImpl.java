...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public  Result  resetPassword(Long id, String oldPassword, String newPassword) throws ServiceException {
			SysUser user = new SysUser();
			user.setId(id);
			user.setPassword(passwordEncoder.encode(newPassword));
			sysUserDao.resetPassword(user);
			log.info("重置密码：{}", user);
...
//				i = sysUserDao.insert(sysUser);
	...
	@Override
	public List<SysUser> selectByDeptId(Long id) {
		return sysUserDao.selectByDeptId(id);
	}
